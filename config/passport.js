...
module.exports = function (passport) {
  ...
  //         var insertQuery = 'INSERT INTO users ( username, password, firstname, lastname, email, phone, city, prov, country, postal_code ) values (?,?,?,?,?,?,?,?,?,?)'
  ...
  //           newUserMysql.city,
  //           newUserMysql.prov,
  //           newUserMysql.country,
  //           newUserMysql.postal_code
  //         ], function (err, rows) {
  //           if (err) { return (err) }
